          ...
          <div className="row pb-1">
              ...
              <div className="card h-100">
                <div className="card-body">
                  <h5 className="card-title">
                    <i className="fas fa-code card-icon-1"></i> Hand-crafted web
                    apps
                  </h5>
            ...
            <div className="col-sm-4">
              <div className="card h-100">
                <div className="card-body">
                  <h5 className="card-title">
                    <i className="fas fa-file-alt card-icon-2"></i> Template
                    based websites
                  </h5>
                  <p className="card-text">
            ...
            <div className="col-sm-4">
              <div className="card h-100">
                <div className="card-body">
                  <h5 className="card-title">
                    <i className="fab fa-wordpress card-icon-3"></i> Wordpress
                    websites
                  </h5>
                  <p className="card-text">
          ...
          <div className="row pb-1">
            <div className="col-sm-4">
              <div className="card h-100">
                <div className="card-body">
                  <h5 className="card-title">
                    <i className="fas fa-users card-icon-4"></i> Remote team
                    member
                  </h5>
                  <p className="card-text">
            ...
            <div className="col-sm-4">
              <div className="card h-100">
                <div className="card-body">
                  <h5 className="card-title">
                    <i className="fas fa-headset card-icon-1"></i> Technical
                    support
                  </h5>
                  <p className="card-text">
            ...
            <div className="col-sm-4">
              <div className="card h-100">
                <div className="card-body">
                  <h5 className="card-title">
                    <i className="fas fa-pen card-icon-2"></i> Documentation
                  </h5>
                  <p className="card-text">
          ...
          <div className="row pb-1">
            <div className="col-sm-4">
              <div className="card h-100">
                <div className="card-body">
                  <h5 className="card-title">
                    <i className="fas fa-feather-alt card-icon-3"></i> Bespoke
                    web content
                  </h5>
                  <p className="card-text">
            ...
            <div className="col-sm-4">
              <div className="card h-100">
                <div className="card-body">
                  <h5 className="card-title">
                    <i className="fas fa-pound-sign card-icon-4"></i> Low-cost
                    websites
                  </h5>
                  <p className="card-text">
            ...
            <div className="col-sm-4">
              <div className="card h-100">
                <div className="card-body">
                  <h5 className="card-title">
                    <i className="fas fa-wrench card-icon-1"></i> Changes,
                    updates &amp; fixes
                  </h5>
                  <p className="card-text">
          ...
          <div className="row pb-1">
            <div className="col-sm-4">
              <div className="card h-100">
                <div className="card-body">
                  <h5 className="card-title">
                    <i className="fas fa-poll-h card-icon-2"></i> Questback /
                    Unipark EFS
                  </h5>
                  <p className="card-text">
            ...
            <div className="col-sm-4">
              <div className="card h-100">
                <div className="card-body">
                  <h5 className="card-title">
                    <i className="fab fa-linux card-icon-3"></i> Linux
                    administration
                  </h5>
                  <p className="card-text">
            ...
            <div className="col-sm-4">
              <div className="card h-100">
                <div className="card-body">
                  <h5 className="card-title">
                    <i className="fas fa-balance-scale-right card-icon-4"></i>{" "}
                    Software evaluation
                  </h5>
                  <p className="card-text">
